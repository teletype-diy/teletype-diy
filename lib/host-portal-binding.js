...
const {FollowState} = require('@teletype-diy/teletype-diy-client')
const BufferBinding = require('./buffer-binding')
const EditorBinding = require('./editor-binding')
const SitePositionsComponent = require('./site-positions-component')
const {getPortalURI, getPortalURIwithPeerId} = require('./uri-helpers')
...
class HostPortalBinding {
  ...
  async initialize () {
    try {
      ...
      this.uri = getPortalURIwithPeerId(this.portal.id, this.client.getClientId())
