...
class PackageInitializationErrorComponent {
  ...
  render () {
    return $.div({className: 'PackageInitializationErrorComponent'},
      ...
      $.p(null, 'Check your config or your internet connection, and restart the package.'),
      $.div(null,
        $.button(
          {
            ref: 'reloadButton',
  ...
  getIssueURL () {
    ...
    const url = new URL('https://github.com/teletype-diy/teletype-diy/issues/new')
  ...
  async restartTeletype () {
    ...
    await packageManager.deactivatePackage('teletype-diy')
    await packageManager.activatePackage('teletype-diy')
  }
}
